The Matrix raining code effect implemented in various formats and across various libraries. Press F11 then F5 for full sreen effect in Chrome and Firefox.
